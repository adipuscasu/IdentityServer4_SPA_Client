...
import { Component, DoCheck, EventEmitter, Input, OnInit, Output, HostBinding } from '@angular/core';
import * as _ from 'lodash';
import { GridColumnType, GridTable, GridService } from '../grid/grid.service';
import { TranslateService } from '@ngx-translate/core';


@Component({
  selector: 'isspa-sm-grid',
  templateUrl: './sm-grid.component.html',
  styleUrls: ['./sm-grid.component.scss']
})
export class SmGridComponent implements OnInit, DoCheck {
